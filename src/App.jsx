...
// labMarkers imported from shared/data.js

// labMeanings imported from shared/data.js

// chartData imported from shared/data.js
const cSets={
...
// clinicalNotes imported from shared/data.js
...
// journeyData imported from shared/data.js
...
export default function GoldenEra(){
  ...
  const TrendChart=({type})=>{
    ...
    const fasting=trendData.fasting;
    const postMeal=trendData.postMeal;
    const night=trendData.night;
    const scores=trendData.scores;
    const wLabels=trendData.weight.labels;const wData=trendData.weight.data;
    const ifData=trendData.ifHours;
